      ...
      <section className="section">
        <div className="site-container guide-layout">
          <article className="article-copy">
            ...
            {step.number === 5 && <p>The tool is not the community. Whether you choose WhatsApp, Facebook, or a group text, use three rules: no sales, no politics, and no vague complaints about neighbors.</p>}
            ...
            {step.number === 10 && <p>Capture the honest arc: what life was like before, what someone tried, what they feared, what happened, and what grew afterward. Photos, flyers, calendars, and specific advice make the story useful.</p>}
