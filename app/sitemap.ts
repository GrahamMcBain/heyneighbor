...
export default function sitemap(): MetadataRoute.Sitemap {
  const base = process.env.NEXT_PUBLIC_SITE_URL || 'https://heyneighbor.org'
  const staticPaths = ['', '/start', '/guide', '/block-party', '/ideas', '/resources', '/resources/first-block-party-kit', '/stories', '/workshop', '/share']
  return [
